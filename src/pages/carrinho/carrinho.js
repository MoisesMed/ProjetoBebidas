  ...
  render() {
    return (
      <View style={styles.boxForm}>
                ...
                <TextInput style={{ marginLeft: 15, backgroundColor: 'white', width: 100, borderColor: '#4EBFFF', marginBottom: 5 }} value={this.state.numero} onChangeText={logradouro => {this.setState({numero})}}></TextInput>
